...
def result_dict_for_batched_example(images,
    ...
    # print(f'2detection_classes: {str(output_dict["detection_classes"])}')
    # 'detection_classes': <tf.Tensor 'add_2:0' shape=(1, 100) dtype=int64>
    ...
    if groundtruth:
        ...
        # print(f'2groundtruth_classes: {str(groundtruth["groundtruth_classes"])}')
